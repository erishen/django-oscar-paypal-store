...
INSTALLED_APPS = [
    ...
    'apps.dashboard.apps.DashboardConfig',  # forked top-level (required for sub-app forks)
    'oscar.apps.dashboard.reports.apps.ReportsDashboardConfig',
    'oscar.apps.dashboard.users.apps.UsersDashboardConfig',
    'apps.dashboard.orders.apps.OrdersDashboardConfig',  # forked: real PayPal refund
    ...
    # Local PayPal Express Checkout integration (self-contained, no legacy pkg)
    'apps.paypal_express',
]
...
# Get real sandbox credentials at https://developer.paypal.com
...
# Project-level translations: override Oscar's bundled zh_CN .mo (which is stale
# and ships empty msgstr for most frontend terms). LOCALE_PATHS takes priority
# over app/library locales.
